...
1) Add the folder 'APIMATICCalculatorLib' into your to your scripts folder e.g scripts.
...
4) To use a generated factory in your controller, injection could be as follows : 
    ...
    myApp.controller('PageCtrl',function($scope,SimpleCalculatorController) {
